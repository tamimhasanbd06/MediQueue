...
export default function TutorsPage() {
  ...
  const fetchTutors = async () => {
    ...
    try {
      ...
      const url = `${API_URL}/tutors?${query.toString()}`;
    ...
    <section className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-blue-50 py-16 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto text-center mb-16">
        ...
        <p className="max-w-3xl mx-auto text-gray-600 text-lg leading-relaxed">
          ...
          filter by course schedule, and book your learning sessions with ease.
        </p>
      </div>
            ...
            >
              ...
              <div className="relative h-72 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4">
                  <span className="bg-blue-600 text-white text-xs px-4 py-2 rounded-full font-semibold">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900">{tutor?.experience || "N/A"}</span>
                  </div>

                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Teaching Mode</span>
                    <span className="text-blue-600">{tutor?.teachingMode || "N/A"}</span>
                  </div>

                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Available Time</span>
                    <span className="text-gray-900">{tutor?.availableTime || "N/A"}</span>
                  </div>

                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Seats</span>
                    <span className="text-gray-900">{tutor?.totalSeats || 0}</span>
                  </div>

                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Duration</span>
                    <span className="text-gray-900">{tutor?.courseDuration || "N/A"}</span>
                  </div>
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex justify-between items-center mb-5">
                    <div>
                      <p className="text-gray-500 text-sm">Session Fee</p>
                  ...
                  <Link href={`/tutors/${tutor?._id}`}>
                    <button className="w-full py-4 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold transition">
                      Book Session
                    </button>
                  </Link>
