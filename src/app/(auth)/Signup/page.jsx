...
import { Eye, EyeOff, Mail, Lock, User, ImageIcon, } from "lucide-react";
...
export default function SignupPage() {
  ...
  const [formData, setFormData] = useState({ name: "", email: "", image: "", password: "", confirmPassword: "", });
  ...
  const handleSubmit = async (e) => {
    ...
    if ( !passwordRegex.test( formData.password )
      ...
      return toast.error( "Password must contain uppercase, lowercase and minimum 6 characters" );
    }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border border-white/20 dark:border-gray-800 rounded-4xl shadow-[0_10px_60px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_60px_rgba(0,0,0,0.4)] p-6 sm:p-8">
          ...
          >
            ...
            <FcGoogle className="text-2xl" /> {googleLoading ? "Connecting..." : "Continue with Google"}
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-8">
            ...
            <Link href="/login" className="ml-1 font-semibold text-blue-600 hover:text-blue-700 hover:underline">
              Login
            </Link>
          </p>
        </div>
