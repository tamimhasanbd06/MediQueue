...
export default function BookedSessionsPage() {
  ...
  return (
    <>
      <title>MediQueue | Booked Sessions</title>

      <section className="min-h-screen px-4 sm:px-6 lg:px-8 py-12 transition-colors duration-500 bg-gray-50 dark:bg-zinc-950">
        <div className="max-w-7xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="rounded-3xl p-6 border flex flex-col justify-center bg-white border-blue-500/30 dark:bg-black dark:border-blue-400/30 shadow-[0_10px_35px_rgba(59,130,246,0.03)] relative overflow-hidden">
